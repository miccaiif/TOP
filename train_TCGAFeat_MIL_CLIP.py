...
from Datasets_loader.dataset_TCGA_LungCancer import TCGA_LungCancer_CLIPFeat
...
if __name__ == '__main__':
    ...
    # Setup loaders
    train_ds_return_bag = TCGA_LungCancer_CLIPFeat(train=True, return_bag=True, feat="RN50")
    ...
    val_ds_return_bag = TCGA_LungCancer_CLIPFeat(train=False, return_bag=True, feat="RN50")
    ...
    # Setup model
    bagPrompt_ctx_init = ["Examine the lung tissue image, looking for gland patterns and mucin (Lung Adenocarcinoma). * * * * * * * * * *",
                          "Examine the lung tissue image, looking for irregular cells and keratinization (Lung Squamous Cell Carcinoma). * * * * * * * * * *",]
